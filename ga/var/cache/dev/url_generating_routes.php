...
return [
    ...
    'app_infos' => [[], ['_controller' => 'App\\Controller\\InfosController::index'], [], [['text', '/infos']], [], [], []],
    'app_post' => [[], ['_controller' => 'App\\Controller\\PostController::index'], [], [['text', '/articles']], [], [], []],
    'post_detail' => [['id'], ['_controller' => 'App\\Controller\\PostController::details'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/post']], [], [], []],
    'app_level' => [['level'], ['_controller' => 'App\\Controller\\PostController::filter'], [], [['variable', '/', '[^/]++', 'level', true], ['text', '/posts/level']], [], [], []],
